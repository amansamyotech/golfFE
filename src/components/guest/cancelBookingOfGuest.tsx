...
import { cancelBookingOfGuest } from "@/services/bookingService";
import { useRouter } from "next/navigation";


interface CancelBookingOftheGuestProps {
    open: boolean;
    onClose: () => void;
...
const CancelBookingOfGuest: React.FC<CancelBookingOftheGuestProps> = ({
    open,
    onClose,
    slot,
    bookingId,
...
export default CancelBookingOfGuest;
