                ...
                <Card sx={{ p: 3, mb: 4, boxShadow: theme.shadows[4], borderRadius: 3 }}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Stack spacing={1}>
                            ...
                            <Typography>
                                <strong>Start Date:</strong> {moment(guest?.customerId?.startDate).format('MMM DD, YYYY')}
                            </Typography>
                        ...
                        <Stack spacing={1}>
                            ...
                            <Typography>
                                <strong>Expiry Date:</strong> {moment(guest?.customerId?.expiryDate).format('MMM DD, YYYY')}
                            </Typography>
