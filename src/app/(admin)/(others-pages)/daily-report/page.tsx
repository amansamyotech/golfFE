...
export default function DailyReport() {
    ...
    const rows = sortLatestFirst(reportData).map((row, index) => ({
        id: index + 1,
        sNo: index + 1,
        ...row,
    }));
    ...
    const columns = [
        ...
        { field: 'totalSales', headerName: 'Total Sales', flex: 1, minWidth: 120 },
        { field: 'totalDiscount', headerName: 'Discount', flex: 1, minWidth: 100 },
        { field: 'totalTransactions', headerName: 'Total Transaction', flex: 1, minWidth: 150 },
        // {
        //     field: 'action',
        //     headerName: 'Action',
        //     width: 80,
